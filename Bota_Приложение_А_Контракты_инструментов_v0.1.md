...
```json
{
  ...
  "esf": { "ref": { }, "date": "2026-05-15", "reg_number": "ESF-…", "status": "delivered", "total": "120000.00", "vat": "16560.00" },
  "diff": { "net": "7.14", "vat": "-8.28", "total": "0.00" },
  "short": "НДС в поступлении меньше ЭСФ на 8,28 ₸ при равном итоге — вероятно НДС «в т.ч.» против «сверху»"
}
```
...
```json
{
  ...
  "pair": {
    ...
    "esf": {
      ...
      "replaces": null,
      "totals": { "net": "103440.00", "vat": "16560.00", "total": "120000.00" }
    },
    "link": "explicit | suggested | none"
  },
  "header_diff": [
    { "field": "net",   "receipt": "103448.28", "esf": "103440.00", "diff": "8.28",  "within_tolerance": false },
    { "field": "vat",   "receipt": "16551.72",  "esf": "16560.00",  "diff": "-8.28", "within_tolerance": false },
    { "field": "total", "receipt": "120000.00", "esf": "120000.00", "diff": "0.00",  "within_tolerance": true },
  ...
  "lines": [
    {
      ...
      "esf_line":     { "n": 1, "name": "Бумага офисная А4 80 г/м2", "unit": "пач", "qty": "100.000", "price": "1034.40", "net": "103440.00", "vat_rate": "16", "vat": "16560.00", "total": "120000.00" },
      "diff": { "qty": "0.000", "price": "165.60", "net": "8.28", "vat": "-8.28", "total": "0.00" },
      "pattern": "R2"
    }
  ],
  "diagnosis": {
    "pattern": "R2",
    "explanation": "Цена в поступлении включает НДС (1200 = 1034,40 × 1,16), в ЭСФ цена без НДС. Итог совпадает, НДС расходится из-за способа расчёта.",
    "confidence": "high"
  },
  "suggested_actions": [
...
```json
{
  "items": [
    {
      "esf": { "ref": { }, "date_turnover": "2026-05-14", "total": "120000.00", "vat": "16560.00", "counterparty_bin": "…" },
      "score": 0.94,
...
```json
{
  ...
  "lines": [ { "n": 1, "price": "1034.40", "qty": null, "vat": "16560.00" } ]
}
```
...
```json
{
  ...
  "document": { "ref": { } },
  "changes": [
    { "line": 1, "field": "Цена", "from": "1200.00", "to": "1034.40" },
    { "line": 1, "field": "СуммаНДС", "from": "16551.72", "to": "16560.00" }
  ],
  "totals_after": { "net": "103440.00", "vat": "16560.00", "total": "120000.00" },
  "postings_affected": [
    { "account_dt": "1330", "account_kt": "3310", "from": "103448.28", "to": "103440.00" },
    { "account_dt": "1420", "account_kt": "3310", "from": "16551.72", "to": "16560.00" }
  ],
  "will_repost": true,
  "checks": [ ],
  "can_apply": true
